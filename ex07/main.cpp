...
void show_grayscale_histogram(map<int, int> *gray_map)
{
    ...
    for(auto color_value : (*gray_map))
    {
        ...
        output_stream << string(color_value.second, '*') << "[" << color_value.second << "]" << endl;
    }
    output_stream.close();
...
void show_rgb_histogram(map<int, int> *red_map, map<int, int> *green_map, map<int, int> *blue_map)
{
...
void read_file(string *file_name, map<int, int> *red_map, map<int, int> *green_map, map<int, int> *blue_map, int *count)
{
    // open in binary mode
    ifstream input_stream(*file_name);
    if(input_stream.fail())
...
int main(int argc, char **argv)
{
    ...
    read_file(&file_input, &red_frequency_map, &green_frequency_map, &blue_frequency_map, &pixel_count);
    ...
    show_rgb_histogram(&red_frequency_map, &green_frequency_map, &blue_frequency_map);
